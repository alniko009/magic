...
class ctNewsletterShortcode extends ctShortcode {
	...
	public function handle($atts, $content = null) {
		...
		$js = 'jQuery(document).ready(function () {
					jQuery("#newsletterSubmit_' . $id . '").click(function(){
						...
						var $linkedin = jQuery("#newsletterLinkedin_' . $id . '").val();
						jQuery.ajax({
							type: "POST",
							...
							success: function (data, textStatus, XMLHttpRequest){
								...
								jQuery(".newsletter-widget p") . html("");
								if(data=="true"){
									...
									jQuery("#newsletterLinkedin_' . $id . '").attr("value", "").hide();
									jQuery("#newsletterLinkedin_' . $id . '").parent("div.mailIcon").hide();
		...
		return '<div class="newsletter-widget widget">
					' . $headerHtml . '
					...
					<form>
						...
						<input name="linkedin" id="newsletterLinkedin_' . $id . '" type="text" placeholder="' . $placeholder2 . '">
	...
	public function getAttributes() {
		return array(
			...
			'placeholder2' => array('label' => __('placeholder2', 'ct_theme'), 'default' => __('Linkedin', 'ct_theme'), 'type' => 'input', 'help' => __("Placeholder text for input", 'ct_theme')),
...
function NewsletterAjax() {
	...
	$message = __("Community join", 'ct_theme') . ": " . $email . ", Linkedin: " . $linkedin;
	$headers_mail = "From: Community join <".esc_attr($email)."> \r\n";
